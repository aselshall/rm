...
- **Leverage current work and ongoing projects (recommended):** Consider building on a project you are already involved in at work, with your supervisor, or within your degree program.
...
- **[Hydrogeological Characterization of the Immokalee Agricultural Field Site](https://github.com/aselshall/rm/blob/main/hw/projects/p35.md)**: Integrates soil-moisture and weather monitoring, groundwater wells, ERT, hydraulic conductivity, and soil analysis to characterize subsurface conditions and groundwater flow
- **[Quantifying Nitrogen and Phosphorus Leaching Using Field Lysimeters](https://github.com/aselshall/rm/blob/main/hw/projects/p80.md)**: Evaluates how innovative soil amendments reduce TN and TP leaching, and affect soil-water dynamics, and nutrient-use efficiency in sandy agricultural soils 
- **[Evaluating Nature-Based Infrastructure for Stormwater Mitigation and Groundwater Recharge](https://github.com/aselshall/rm/blob/main/hw/projects/p01.md)**:Assesses how green infrastructure reduce runoff and peak flow while enhancing groundwater recharge and climate resilience
- **[Geospatial Prioritization of Nature-Based Infrastructure for Stormwater Management in Naples, Florida](https://github.com/aselshall/rm/blob/main/hw/projects/p36.md)**: Applies a geospatial multicriteria framework to identify feasible locations and prioritize nature-based stormwater BMPs based on runoff sources, storage potential, infiltration conditions, and site constraints.
