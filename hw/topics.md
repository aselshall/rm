...
- **[Hydrogeological Characterization of the Immokalee Agricultural Field Site](https://github.com/aselshall/rm/blob/main/hw/projects/p35.md)**: Integrates soil-moisture and weather monitoring, groundwater wells, ERT, hydraulic conductivity, and soil-texture analysis to characterize subsurface conditions and groundwater flow.
- **[Quantifying Nitrogen and Phosphorus Leaching Using Field Lysimeters](https://github.com/aselshall/rm/blob/main/hw/projects/p80.md)**: Evaluates how humic acid and reduced fertilizer application affect TN and TP leaching, soil-water dynamics, and nutrient-use efficiency in sandy agricultural soils.
- **[Evaluating the Impact of Land Use and Nature-Based Infrastructure on Groundwater Recharge in South Florida](https://github.com/aselshall/rm/blob/main/hw/projects/p01.md)**: Focuses on enhancing the climate resiliency of groundwater resources in South Florida through nature-based infrastructure
